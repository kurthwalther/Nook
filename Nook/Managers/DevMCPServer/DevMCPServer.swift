...
final class DevMCPServer {
    ...
    private static let toolList: [[String: Any]] = (BrowserTools.allTools.filter { $0.name != "executeJavaScript" && !KurthCopilot.reemplazadas.contains($0.name) } + devTools + KurthMCPTools.tools + KurthCopilot.tools + KurthSync.herramientas + KurthPasswords.tools + KurthSplit.tools).map { // kurth: sincronización
