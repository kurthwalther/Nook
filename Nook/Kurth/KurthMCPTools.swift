...
enum KurthMCPTools {
    ...
    static let settings: [Setting] = [
        ...
        Setting(key: "kurth.loadingStyle", type: "string", defaultValue: "arc",
                info: "Indicador de carga del botón de recargar: arc, comet, ring, snake (de loading.dev) o spinner (rueda clásica de macOS)"),
