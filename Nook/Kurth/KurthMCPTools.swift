...
enum KurthMCPTools {
    ...
    static let settings: [Setting] = [
        ...
        Setting(key: KurthJalarParaRecargar.ajuste, type: "bool", defaultValue: true,
                info: "Jalar para recargar: con la página hasta arriba, jalar hacia abajo con dos dedos en el trackpad y soltar pasado el umbral (golpe háptico) recarga, como Safari 27"),
        Setting(key: KurthJalarParaRecargar.ajusteDistancia, type: "number", defaultValue: KurthJalarParaRecargar.distanciaDefault,
                info: "Jalar para recargar: puntos de estiramiento de la página para quedar lista (24–200). Más alto pide un jalón más largo"),
